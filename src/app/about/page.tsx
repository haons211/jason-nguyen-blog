          ...
          <div className="md:col-span-1">
            ...
            <div className="space-y-4">
              <div>
                ...
                <a href="mailto:hello@jasonnguyen.dev" className="text-blue-600 dark:text-blue-400 hover:underline">
                  hello@jasonnguyen.dev
                </a>
              </div>
              <div>
                <h3 className="font-medium text-gray-900 dark:text-gray-100">On the web</h3>
                <ul className="space-y-2 mt-2">
                  <li>
                    <a href="https://twitter.com/yourusername" className="text-blue-600 dark:text-blue-400 hover:underline flex items-center">
                  ...
                  <li>
                    <a href="https://github.com/yourusername" className="text-blue-600 dark:text-blue-400 hover:underline flex items-center">
                      <svg className="h-5 w-5 mr-2" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  <li>
                    <a href="https://linkedin.com/in/yourusername" className="text-blue-600 dark:text-blue-400 hover:underline flex items-center">
                      <svg className="h-5 w-5 mr-2" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="md:col-span-2 space-y-8">
            ...
            <section>
              ...
              <ul className="grid grid-cols-2 gap-2">
                <li className="bg-gray-100 dark:bg-gray-800 px-3 py-2 rounded">JavaScript & TypeScript</li>
                <li className="bg-gray-100 dark:bg-gray-800 px-3 py-2 rounded">React & Next.js</li>
                <li className="bg-gray-100 dark:bg-gray-800 px-3 py-2 rounded">Node.js</li>
                <li className="bg-gray-100 dark:bg-gray-800 px-3 py-2 rounded">GraphQL</li>
                <li className="bg-gray-100 dark:bg-gray-800 px-3 py-2 rounded">UI/UX Design</li>
                <li className="bg-gray-100 dark:bg-gray-800 px-3 py-2 rounded">Responsive Design</li>
                <li className="bg-gray-100 dark:bg-gray-800 px-3 py-2 rounded">Performance Optimization</li>
                <li className="bg-gray-100 dark:bg-gray-800 px-3 py-2 rounded">Technical Writing</li>
              </ul>
            </section>
